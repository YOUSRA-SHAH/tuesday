...
import "slick-carousel/slick/slick-theme.css";
    ...
    const SlickSlider = () => {
      ...
      const settings = {
        ...
        responsive: [
          ...
          {
            breakpoint: 600, // For screen widths <= 600px
            settings: {
              slidesToShow: 1,
            },
          },
   ...
   <div className="mainHeading-section">
          <h1 className='text-start'>OUR HAPPY CUSTOMERS</h1>
      </div>
   </div>
    ...
    <div style={{ padding: "20px" }}>
      ...
      <Slider {...settings}>
        <div className="p-sm-3">
            ...
            <div className="main-card-slider p-3">
            <div>
<svg width={21} height={17} viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
